...
error_col3 <- c(0.09, 0.23, 0.38, 0.57, 0.8, 0.4)  # 移除最后一行数据对应的误差值
...
col3_data <- diffs_sub[-(nrow(diffs_sub) - 1), 3]  # 移除倒数第二行数据
#col3_data <- diffs_sub[-c((nrow(diffs_sub) - 1), nrow(diffs_sub)), 3]  # 移除最后两行数据
